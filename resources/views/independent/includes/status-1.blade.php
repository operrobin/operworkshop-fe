<div id="penjemputan2" class="content_area">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-8 top_padd">
                    <p class="bold_font">Anda telah mendapatkan driver.<br>Dimohon untuk menunggu<br>Driver kami akan menghubungi anda.</p>
                </div>
            </div>
        </div>
    </div>
