		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form">
				<span class="contact100-form-title">
                  ...
                  <p style="font-weight: bold;font-size: 18px;margin-bottom: 18px">Booking Gagal</p>
                <p>Mohon maaf sepertinya sistem kami sedang overload.Mungkin anda ingin mencoba booking service lagi?</p>
