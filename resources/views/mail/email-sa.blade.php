                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                    <tr>
                      ...
                      <td style="font-family: Roboto; font-size: 14px; vertical-align: top;">
                        <p>Bila anda mendapatkan email ini, berarti ada customer baru dibengkel anda.</p>
                        <p style="font-family: Roboto; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Nama Customer: {{ $fullname }} </p>
                          <p style="font-family: Roboto; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Kode booking : {{ $booking_no }} </p>
                          
                         
                          <p style="font-family: Roboto; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Waktu booking : {{ $booking_time }} </p>
